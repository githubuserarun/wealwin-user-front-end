...
const SignupPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if ((usernameError === null && emailError === null && passwordError === null) && mismatchCheck) {
                        ...
                        <div className="card-body">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3 d-flex flex-row align-items-end">
                                    ...
                                    <button type='button' className='icon h-25 border-0' onClick={togglePassword}>
                                        {isPassShow ? <FaRegEyeSlash size={20} /> : <FaRegEye size={20} />}</button>
                                </div>
                                <div className="mb-3  d-flex flex-row align-items-end ">
                                    <div className='flex-grow-1'>
                                ...
                                <div className="d-grid gap-2">
                                    ...
                                    <button type="button" className="btn btn-warning" onClick={() => {/* Add login navigation logic */ }}>Login</button>
                                </div>
                            </form>
                        </div>
                    </div>
